...
::: {important}
ODISEO's distribution module inherits from Cosmos SDK's [`distribution`](https://docs.cosmos.network/master/modules/distribution/) module. This document is a stub and covers mainly important ODISEO-specific notes about how it is used.
:::
...
:::{important}
Passive distribution means that validators and delegators need to manually collect their fee rewards by [submitting withdrawal transactions](../how-to/achillesd/subcommands.md#tx-distribution-withdraw-rewards).
:::
...
The community pool is a reserve of tokens designated for funding projects that promote further adoption and stimulate growth for the ODISEO economy. The comminuty pool used to be funded by seigniorage. As of Columbus-5, all seigniorage is burned, and the community pool no longer receives funding.
